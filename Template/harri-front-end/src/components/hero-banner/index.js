...
const slider_data = [
  {
    ...
    pre_title: (
      <>
        Livros-Objeto <br /> Transdisciplinares
      </>
    ),
    title: (
      <>
        Filosofia, Estética <br /> e Pensamento Crítico
      </>
    ),
    img: slider_img_1,
  },
  {
    ...
    pre_title: (
      <>
        Editora N-1 <br /> Edições
      </>
    ),
    title: (
      <>
        Livros que <br /> Transformam Ideias
      </>
    ),
    img: slider_img_2,
  },
  {
    ...
    title: (
      <>
        Entre a Clínica, <br /> Antropologia e Política
      </>
    ),
    img: slider_img_3,
  },
