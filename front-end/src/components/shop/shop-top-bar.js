  ...
  return (
    <div className="shop__sort-item">
      <div className="shop__sort-select">
        <NiceSelect
          options={[
            { value: "Ordenar", text: "Ordenar" },
            { value: "Produto Mais Recente", text: "Produto Mais Recente" },
            { value: "Preço: menor para maior", text: "Preço: menor para maior" },
            { value: "Preço: maior para menor", text: "Preço: maior para menor" },
          ]}
          defaultCurrent={0}
